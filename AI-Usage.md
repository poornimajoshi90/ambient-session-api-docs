...
| ------------------------------------- | ------------------------------------------ | ---------------------------------------------------- |
| `[!IMPORTANT]` text on same line      | Does not render correctly in GitHub        | Moved text to next line after `[!IMPORTANT]`         |
...
_Documentation created as part of a technical writing assignment._
